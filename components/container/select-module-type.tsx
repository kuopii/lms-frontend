...
export const SelectModuleType = memo(
  ({
    value,
    onChange,
    ...
    return (
      <Select
        value={value}
        onValueChange={(val) => onChange(val as ModuleType)}
      >
        <SelectTrigger
          className={cn(
            "h-11 w-full border-[#FFFFFF66] bg-[#333333]",
            className,
          )}
        >
...
SelectModuleType.displayName = "SelectModuleType";
