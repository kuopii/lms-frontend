...
export const QuestionField = ({
  ...
  const paths = useMemo(
    () => ({
      ...
      voice_limit: `${questionPath}.voice_limit`,
    }),
    [questionPath],
  );
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-64 text-xs">
                      <p>
                        Choose &quot;Preset&quot; for common durations or
                        &quot;Custom&quot; to set manually — maximum 300 seconds
                        (5 minutes).
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ...
                <div className="flex items-center gap-2">
                  <Select
                    ...
                    onValueChange={(value: "preset" | "custom") => {
                      setLimitType(value);
                      setValue(paths.voice_limit, 0);
                    }}
                  >
                    <SelectTrigger>
                      <SelectValue placeholder="Pilih tipe limit" />
                    </SelectTrigger>
                    <SelectContent>
