...
const accurations = [
  { id: "01", test_name: "Matching Heading", accuracy: 10 },
  { id: "02", test_name: "Paragraph Completion", accuracy: 18 },
  { id: "03", test_name: "True/False/Not Given", accuracy: 20 },
];
        ...
        <div className="card-custom w-full p-5 lg:w-[500px]">
          <div className="mb-6 flex flex-col gap-2">
            <div className="flex gap-4">
              ...
              >
                {accurationType === AccurationType.highest ? (
                  <FaArrowUp className="text-destructive size-4" />
                ) : (
                  <FaArrowDown className="text-primary size-4" />
                )}
              </Button>
            </div>
